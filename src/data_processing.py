...
class DataProcessing:
    def __init__(self,input_path , output_path):
        ...
        logger.info("Data Processing Begins....")
    ...
    def preprocess(self):
        try:
            ...
            raise CustomException("Initial data processing is Failed" , e)
    ...
    def split_data(self):
        try:
            ...
            logger.info("Data partition successfull")
        
        except Exception as e:
            logger.error(f"Error while splittting data {e}")
            raise CustomException("Data Partitioning Failed" , e)
    ...
    def run(self):
        ...
        logger.info("Data Procesing Ends....")
